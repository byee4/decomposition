...
def main(argv=None):  # IGNORE:C0111
    ...
    fig, ax = plt.subplots()
    plotter = PCAPlotter.pcaplot(counts, colors=colors, ax=ax, bokeh=False)
    fig.savefig(output_file)

    plotter.prcomp.to_csv(os.path.splitext(output_file)[0] + '.txt', sep='\t')
